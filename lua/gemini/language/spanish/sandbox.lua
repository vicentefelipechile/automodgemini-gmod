...
local SandboxModule = {
    ...
    ["PlayerHurt"] =           [[El jugador "%s" ha recibido %s de daño por "%s" y ahora %s]],
    ...
    ["OnPhysgunPickup"] =      [[El jugador "%s" agarro la entidad "%s" con la pistola fisica en las coordenadas %s.]],
    ["PhysgunDrop"] =          [[El jugador "%s" solto la entidad "%s" con la pistola fisica en las coordenadas %s.]],
